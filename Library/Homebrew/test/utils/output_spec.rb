...
RSpec.describe Utils::Output do
    ...
    context "when $stdout is a TTY" do
      ...
      context "with HOMEBREW_NO_EMOJI set" do
        ...
        it "returns a string with colored info" do
          expect(pretty_installed_output)
            .to match(/#{esc 32}#{esc 1}foo \(installed\)#{esc 0}#{esc 0}/)
        end
      end
    end
  ...
  describe "#pretty_uninstalled" do
    ...
    context "when $stdout is a TTY" do
      ...
      context "with HOMEBREW_NO_EMOJI set" do
        ...
        it "returns a string with colored info" do
          expect(pretty_uninstalled_output)
            .to match(/#{esc 31}#{esc 1}foo \(uninstalled\)#{esc 0}#{esc 0}/)
        end
      end
    end
  ...
  describe "#pretty_outdated" do
    ...
    context "when $stdout is a TTY" do
      ...
      context "with HOMEBREW_NO_EMOJI unset" do
        it "returns a string with a colored warning" do
          expect(pretty_outdated_output)
            .to match(/#{esc 1}foo #{esc 33}⚠#{esc 0}#{esc 0}/)
        end
      end
      ...
      context "with HOMEBREW_NO_EMOJI set" do
        ...
        it "returns a string with colored info" do
          expect(pretty_outdated_output)
            .to match(/#{esc 33}#{esc 1}foo \(outdated\)#{esc 0}#{esc 0}/)
        end
      end
    end
