    ...
    module Commands
      ...
      module Cleanup
        ...
        private_class_method def self.kept_formulae(global: false, file: nil)
          ...
          @kept_formulae ||= begin
            # Avoid intermediate array allocation by using filter_map instead of select.map
        ...
        private_class_method def self.kept_casks(global: false, file: nil)
          ...
          # Avoid intermediate array allocation by using filter_map instead of select.flat_map
        ...
        def self.taps_to_untap(global: false, file: nil)
          ...
          # Avoid intermediate array allocation by chaining map into filter_map
          kept_taps += kept_formulae.filter_map { |f| f.tap&.name }
