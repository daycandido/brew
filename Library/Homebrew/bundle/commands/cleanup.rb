    ...
    module Commands
      ...
      module Cleanup
        ...
        private_class_method def self.kept_formulae(global: false, file: nil)
          ...
          @kept_formulae ||= begin
            # Optimized by replacing select.map with filter_map to avoid intermediate array allocations
        ...
        def self.taps_to_untap(global: false, file: nil)
          ...
          # Optimized by replacing chained enumerators with filter_map to reduce allocations
