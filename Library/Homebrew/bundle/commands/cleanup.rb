    ...
    module Commands
      ...
      module Cleanup
        ...
        private_class_method def self.kept_formulae(global: false, file: nil)
          ...
          @kept_formulae ||= begin
            # ⚡ Bolt: Use `filter_map` instead of `select` and `map` to avoid allocating an intermediate array
        ...
        private_class_method def self.kept_casks(global: false, file: nil)
          ...
          # ⚡ Bolt: Use `filter_map` instead of `select` and `flat_map` to avoid allocating an intermediate array
