    ...
    module Commands
      ...
      module Cleanup
        ...
        private_class_method def self.kept_formulae(global: false, file: nil)
          ...
          @kept_formulae ||= begin
            # Optimize performance by using filter_map instead of select.map to avoid intermediate array allocations.
        ...
        private_class_method def self.kept_casks(global: false, file: nil)
          ...
          # Optimize performance by using filter_map instead of select.flat_map
