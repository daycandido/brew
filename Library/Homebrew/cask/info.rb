...
module Cask
  class Info
    ...
    def self.installation_info(cask)
      return Formatter.error("Not installed#{" ✘" unless Homebrew::EnvConfig.no_emoji?}") unless cask.installed?
