...
## 2024-06-15 - Avoid map.any?
**Learning:** Using `.map(&:property).any?` evaluates the entire collection and allocates an intermediate array, increasing garbage collection pressure.
