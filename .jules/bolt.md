...
**Learning:** Using `.map(&:property).any?` evaluates the entire collection and allocates an intermediate array before evaluating the condition, increasing garbage collection pressure.
